			...
			title: [{
				text:datas.timeline[obj]+'{nums1|\n\n确诊：   '+datas.title_data.total[obj]+'}'+
						...
						textStyle:{
							...
							'fontWeight':800,
							'rich':{
								'nums0':{'color':'#fff','fontSize':26,'fontWeight':800},
								'nums1':{'color': '#43bbff','fontSize':16,'fontWeight':800},
								'nums2':{'color': '#69c79b','fontSize':16,'fontWeight':800},
								'nums3':{'color': '#f88c43','fontSize':16,'fontWeight':800},
								'nums4':{'color': '#e87272','fontSize':16,'fontWeight':800},
								'nums5':{'color': '#e80000','fontSize':16,'fontWeight':800},
								'nums6':{'color': '#ac533f','fontSize':16,'fontWeight':800},
							},
						},
						x:'0%',
						y:'0%'
					...
					},
					{
						...
						itemStyle:{
							normal: {
								color:'#1DB7E5',
								label: {
									show: false,color: '#1DB7E5',textStyle: {
										fontWeight:'bolder',fontSize : '12',fontFamily : '微软雅黑',color : '#0000ac',
										},
									},
								},
						},
